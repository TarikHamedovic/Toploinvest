...
Window {
    ...
    property string opsteUpravljanjeINadgledanje : "Opste Upravljanje I Nadgledanje"
    visible: true
    width: 1920
    height: 1080
    title: opsteUpravljanjeINadgledanje
    color: "lightgrey"
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: {
                opsteUpravljanjeINadgledanjeId.close();
            }
        }
    }
    ...
    Row {
            ...
            Text {
                text: "Trenutni pregled: <b>Opšte upravljanje i nadgledanje</b>"
                font.pixelSize: 20
            }
        }
}
